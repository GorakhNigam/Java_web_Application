...
//	EmployeePSS pss;
	...
	public int addEmployee(Employee empl) {
		...
		Object args[] = {count,empl.getEmployeeName(), empl.getEmailId(),empl.getSource(),empl.getDestination(),empl.getTravelPurpose(),empl.getTravelMode(),empl.getDuration(),empl.getTravelExpense(),status};
